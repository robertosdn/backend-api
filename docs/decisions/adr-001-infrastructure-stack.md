...
Esta decisao nao escolhe ainda o formato de token de login, o algoritmo de hash de senha, a crate Rust de persistencia ou as regras de autorizacao administrativa. Essas decisoes devem ser registradas antes da implementacao dos endpoints.
